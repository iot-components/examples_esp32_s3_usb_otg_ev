...
#define BOARD_UART_TXD_PIN BOARD_IO_FREE_1   //45
#define BOARD_UART_RXD_PIN BOARD_IO_FREE_2   //46

#ifdef CONFIG_UART_AUTO_DOWNLOAD
#define BOARD_AUTODLD_EN_PIN BOARD_IO_FREE_6   //3
#define BOARD_AUTODLD_IO0_PIN BOARD_IO_FREE_4   //26
